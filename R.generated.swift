...
struct R: Rswift.Validatable {
  ...
  struct segue {
    ...
    struct movieDetailViewController {
      /// Segue identifier `trailerSegue`.
      static let trailerSegue: Rswift.StoryboardSegueIdentifier<UIKit.UIStoryboardSegue, MovieDetailViewController, TrailerMovieViewController> = Rswift.StoryboardSegueIdentifier(identifier: "trailerSegue")
      
      /// Optionally returns a typed version of segue `trailerSegue`.
      /// Returns nil if either the segue identifier, the source, destination, or segue types don't match.
      /// For use inside `prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?)`.
      static func trailerSegue(segue: UIKit.UIStoryboardSegue) -> Rswift.TypedStoryboardSegueInfo<UIKit.UIStoryboardSegue, MovieDetailViewController, TrailerMovieViewController>? {
        return Rswift.TypedStoryboardSegueInfo(segueIdentifier: R.segue.movieDetailViewController.trailerSegue, segue: segue)
      }
  ...
  struct storyboard {
    ...
    /// Storyboard `TrailerMovie`.
    static let trailerMovie = _R.storyboard.trailerMovie()
    ...
    /// `UIStoryboard(name: "TrailerMovie", bundle: ...)`
    static func trailerMovie(_: Void = ()) -> UIKit.UIStoryboard {
      return UIKit.UIStoryboard(resource: R.storyboard.trailerMovie)
    }
...
struct _R: Rswift.Validatable {
  ...
  struct storyboard: Rswift.Validatable {
    ...
    struct movieDetail: Rswift.StoryboardResourceWithInitialControllerType, Rswift.Validatable {
      ...
      static func validate() throws {
        if UIKit.UIImage(named: "play_icon") == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'play_icon' is used in storyboard 'MovieDetail', but couldn't be loaded.") }
      }
      
      fileprivate init() {}
    }
    
    struct movieTrailer: Rswift.StoryboardResourceWithInitialControllerType {
      typealias InitialController = AVKit.AVPlayerViewController
    ...
    struct trailerMovie: Rswift.StoryboardResourceWithInitialControllerType {
      typealias InitialController = TrailerMovieViewController
      
      let bundle = R.hostingBundle
      let name = "TrailerMovie"
